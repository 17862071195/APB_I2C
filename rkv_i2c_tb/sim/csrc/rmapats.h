...
extern "C" {
#endif
void  hs_0_M_0_21__rkv_i2c_tb_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_0_0__rkv_i2c_tb_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_0_1__rkv_i2c_tb_simv_daidir (UB  * pcode, scalar  val, U  I677, scalar  * I1303, U  did);
void  hs_0_M_0_2__rkv_i2c_tb_simv_daidir (UB  * pcode);
void  hs_0_M_0_5__rkv_i2c_tb_simv_daidir (UB  * pcode, UB  val);
void  hs_0_M_0_11__rkv_i2c_tb_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_1_21__rkv_i2c_tb_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_1_0__rkv_i2c_tb_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_1_1__rkv_i2c_tb_simv_daidir (UB  * pcode, scalar  val, U  I677, scalar  * I1303, U  did);
void  hs_0_M_1_2__rkv_i2c_tb_simv_daidir (UB  * pcode);
void  hs_0_M_1_5__rkv_i2c_tb_simv_daidir (UB  * pcode, UB  val);
void  hs_0_M_1_11__rkv_i2c_tb_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_2_0__rkv_i2c_tb_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_2_5__rkv_i2c_tb_simv_daidir (UB  * pcode, UB  val);
