...
# DVE full session
# Saved on Fri Dec 30 19:55:15 2022
# Designs open: 1
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 436} {height 523} {dock_state left} {dock_on_new_line true} {child_hier_colhier 331} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 602} {height 523} {dock_state left} {dock_on_new_line true} {child_data_colvariable 246} {child_data_colvalue 204} {child_data_coltype 147} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 728]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 2500
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 728
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 2559} {height 727} {dock_state bottom} {dock_on_new_line true}}
...
gui_set_env SIMSETUP::SIMARGS {{+ntb_random_seed=1230195326 +UVM_NO_RELNOTES +UVM_VERBOSITY=UVM_HIGH +UVM_TESTNAME=i2c_master_tx_abrt_intr_test -a out/sim/i2c_master_tx_abrt_intr_test_1230195326.log -cm_dir out/cov.vdb -cm_name i2c_master_tx_abrt_intr_test_1230195326}}
...
gui_sim_run Ucli -exe rkv_i2c_tb.simv -args { +ntb_random_seed=1230195326 +UVM_NO_RELNOTES +UVM_VERBOSITY=UVM_HIGH +UVM_TESTNAME=i2c_master_tx_abrt_intr_test -a out/sim/i2c_master_tx_abrt_intr_test_1230195326.log -cm_dir out/cov.vdb -cm_name i2c_master_tx_abrt_intr_test_1230195326 -ucligui} -dir /home/verifier/DVT_Code/APB_I2C/rkv_i2c_tb/sim/out/obj -nosource
}
}
